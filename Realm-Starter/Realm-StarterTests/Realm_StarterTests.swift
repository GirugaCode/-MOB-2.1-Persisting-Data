//
//  Realm_StarterTests.swift
//  Realm-StarterTests
//
//  Created by Ryan Nguyen on 5/6/19.
//  Copyright © 2019 Danh Phu Nguyen. All rights reserved.
//

import XCTest
import RealmSwift
@testable import Realm_Starter

class Realm_StarterTests: XCTestCase {
    ...
    func testSaveAndUpdateBook() {
        ...
        do {
            ...
            let book = bookStore.createBook("Hamlet", author: "William", year: 1599)
            ...
            let foundBooks = bookStore.findBooksByTitle("Hamlet")
            XCTAssertEqual(foundBooks.count, 1)
            
            let updatedAuthor = foundBooks.first
            XCTAssertEqual(updatedAuthor?.author, "William Shakespeare")
